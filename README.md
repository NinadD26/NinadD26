...
- Architected 8 production microservices across dev, stage, uat & prod environments
- Implemented mono-repo CI/CD with per-service triggers → **70% fewer builds**
...
- Created modular Terraform for ECS services, ALB, and task definitions
...
- Built event-driven file scanning: S3 → Lambda → Scan → Quarantine
- Achieved **100% file scanning coverage** with automated quarantine
- Fully automated infrastructure provisioning and deployment

### **📊 CloudWatch Monitoring Automation**
*Reliability • Zero-Touch Monitoring*
> **Tech:** Terraform • CloudWatch • ECS • DynamoDB • GitLab CI/CD

- Automated creation of **200+ CloudWatch alarms** across environments
